...
public class SquareIntervalSpecificationTest {

    SquareIntervalSpecification specification;
    EllipseWareHouse wareHouse;

    @BeforeTest
    public void setUp() {
        this.specification = new SquareIntervalSpecification(1.0, 100.0);
    ...
    public void testSpecifyFalse() {
        Ellipse ellipse = new Ellipse(new Point2d(2.0, 3.0), new Point2d(4.0, 6.0));
        EllipseData data = new EllipseData(100.0, 101.0);
        wareHouse.put(ellipse.getEllipseId(), data);
        boolean condition = specification.specify(ellipse);
